...
public interface CourseService {
    void save(CourseReq courseReq) throws IOException;
    ...
    PageResponse<CourseResponse> getCoursesWithCursor(Long cursor, String sort, String keyword, int size, Long categoryId);
